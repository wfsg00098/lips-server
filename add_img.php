...
<section id="main">
    <div class="inner">
        <form method="post" enctype="multipart/form-data">
            ...
            选择图片 （支持jpg、gif、png格式，大小≤2MB）<br><input type="file" name="content"><br><br>
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (!mysqli_num_rows($result))
                    {
                        ...
                        $result = mysqli_query($sql,"insert `".$brand."_".$series."_".$number."` values('img','".$file_save_location.$content."','".$describ."','','','','','','');");
                        if ($log_operation) logger($sql,$_COOKIE[$usercookie],"添加图片：".$brand." - ".$series." - ".$number." - ".$describ."(".$brand_show." - ".$series_show." - ".$number.")");
